...
#### Description
[Lichess][7] `[7]` is a very popular chess program for a variety of players. It is a web-based application that presents itself as a one-stop site for all things chess: *news*, *tournaments*, *coaching*, *match analysis*, *puzzles*, etc.. It's also open-source and under the [AGPL license](https://en.wikipedia.org/wiki/GNU_Affero_General_Public_License). Scala is the coding language for it, as well as some others like Typescript. Users of Lichess can play games with random people or friends online, as well as train their skills against a powerful AI that can be adjusted based on one's *elo*. The coaching system is quite extensive, allowing users to request help from excellent players or to provide their own expertise for others. Further, users can make an account to track their progress through [Stockfish][8] `[8]`. They can use this tracking to assess their skill level and be matched with those of similar skill. They can also complete puzzles or train against an AI of similar level. 

#### Comparison
Lichess is a solid choice for users wanting a web-based chess application that provides more than enough features for playing chess; In contrast, my program will be a solid choice for users wanting a *desktop application* that will have as many features as *necessary* and only that many. Rather than having to learn how to navigate a specific webpage, users can just run an executable and be greeted with a streamlined interface. The myriad of options to choose from only serve to bloat the screen and make it less accessible to some users, like new players just wanting to play a game of chess. I believe the average user of a chess program won't need coaching, news, puzzles, tournaments, etc.. I won't be making any sort of account system, as I find users can be deterred from a program as soon as it asks them to make an account. All these measures will ensure that users will easily understand how to use my application and won't be deterred from choice overload. Additionally, my application being of the desktop variety allows users to install the program onto their own device. This decision was made to set my program apart from the other very solid, web-based options. Being a desktop app, users don't have to worry about not having internet access, or running a full browser in the background. It will be runnable regardless, with only some features requiring internet access, like playing online. It will also be easier to guarantee security, as it is on the machine itself and not directly exposed to the internet.

### **Chess.com**
<img src='./images/chess.com.png' width='45%'/>

#### Description
[Chess.com][9] `[9]` is another popular chess program, perhaps even more than Lichess due to the difference in player count (Lichess, as of this viewing, had 41,000 players, compared to chess.com's 216,000). PHP is used for the main site, with Java and javascript being used for the live server and UI respectively. It's feature set is similar to Lichess in that there are a lot of tools for experienced users to take advantage of, but to most users they will likely remain unused. One can view the news, look for coaching, play in tournaments, etc.. Though, an account is required to be set up for a user to play any sort of chess variant. 

#### Comparison
Again, this is another great option for users to experience all things chess. Cheesy, however, will specifically be marketed as a more simple program with significantly less bloat. Both will allow users to play chess, but the use case will determine whether someone should use chess.com or Cheesy. If one wants to improve their skills or view chess-related content, they should refer to chess.com; but if they are looking for a game to boot up at a get together with some friends to play, they should play Cheesy. Though, there some important distinctions setting the two more apart. There's no doubt that chess.com boasts a huge, uncontestable  playerbase. To some people, this may matter. Regardless, Cheesy is more intended for casual settings. Not having such a community isn't necessary for some friends to have a good time playing chess. Also, chess.com has an account system which, again, I think usually makes users uncomfortable or frustrated. On Cheesy, no features are locked behind an account wall; it's plug and play, easy as that.
...
[8] T. Romstad, M. Costalba, and J. Kiiski, “Stockfish 15,” Stockfish. [Online]. Available: https://stockfishchess.org/. [Accessed: 30-Sep-2022]. 
